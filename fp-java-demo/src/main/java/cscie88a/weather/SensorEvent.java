...
public class SensorEvent {
    ...
    public SensorEvent(String eventId, String sensorId, String sensorType, String windDirection,
                       long eventTimestamp, String zipCode, float humidityPercentage, long windSpeedInMPH,
                       float pressureInAtm, float temperatureInCelcius) {
